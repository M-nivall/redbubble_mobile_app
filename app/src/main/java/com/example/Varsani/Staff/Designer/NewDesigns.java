...
public class NewDesigns extends AppCompatActivity {
    private List<BookingModel> list;
    private AdapterDesign adapterDesign;
    ...
    public void newOrders(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_ASSIGNED_DESIGNS,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                adapterDesign=new AdapterDesign(getApplicationContext(),list);
                                recyclerView.setAdapter(adapterDesign);
            ...
            protected Map<String,String> getParams()throws AuthFailureError {
                ...
                params.put("designerID",user.getClientID());
                Log.e("PARAMS","" +params);
                return params;
            }
        };
