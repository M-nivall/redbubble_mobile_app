...
import com.example.Varsani.Staff.Designer.NewDesigns;
...
import com.example.Varsani.Staff.ServMrg.CompletedDesign;
import com.example.Varsani.Staff.ServMrg.ConfirmCompletion;
import com.example.Varsani.Staff.ServMrg.PendingAllocation;
...
import com.example.Varsani.Staff.Store_mrg.AwaitingStockArrival;
...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                ...
                } else if (id == R.id.nav_pending_allocation) {
                    Intent npa = new Intent(getApplicationContext(), PendingAllocation.class);
                    startActivity(npa);

                } else if (id == R.id.nav_completed_design) {
                    Intent ncd = new Intent(getApplicationContext(), CompletedDesign.class);
                    startActivity(ncd);

                } else if (id == R.id.nav_completed_services) {
                    Intent cs = new Intent(getApplicationContext(), ServiceCompleted.class);
                    startActivity(cs);

                } else if (id == R.id.nav_confirm_completion) {
                    Intent ncc = new Intent(getApplicationContext(), ConfirmCompletion.class);
                    startActivity(ncc);
                ...
                } else if (id == R.id.nav_orders_to_ship) {
                    ...
                    Intent nt = new Intent(getApplicationContext(), ViewTools.class);
                    startActivity(nt);
                    ...
                    Intent nps = new Intent(getApplicationContext(), ProceedService.class);
                    startActivity(nps);
                ...
                } else if (id == R.id.nav_assigned_designs) {
                    Intent nad = new Intent(getApplicationContext(), NewDesigns.class);
                    startActivity(nad);
                ...
                } else if (id == R.id.nav_awaiting_arrival) {
                    Intent im = new Intent(getApplicationContext(), AwaitingStockArrival.class);
                    startActivity(im);
    ...
    public void check(){
        ...
        navigationView.getMenu().findItem(R.id.nav_orders_to_ship).setVisible(false);
        ...
        navigationView.getMenu().findItem(R.id.nav_awaiting_arrival).setVisible(false);
        ...
        navigationView.getMenu().findItem(R.id.nav_pending_allocation).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_assigned_designs).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_completed_design).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_tools).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_proceed_service).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_completed_services).setVisible(false);
        navigationView.getMenu().findItem(R.id.nav_confirm_completion).setVisible(false);
        ...
        if(session.isLoggedIn()) {
            ...
            if (user.getUser_type().equals("Finance")) {
            ...
            } else if (user.getUser_type().equals("Dispatch manager")) {
                navigationView.getMenu().findItem(R.id.nav_orders_to_ship).setVisible(true);
                ...
                navigationView.getMenu().findItem(R.id.nav_awaiting_arrival).setVisible(true);
                ...
                //navigationView.getMenu().findItem(R.id.nav_confirm_completion).setVisible(true);
                ...
                navigationView.getMenu().findItem(R.id.nav_proceed_service).setVisible(true);

            }else if (user.getUser_type().equals("Designer")) {
                navigationView.getMenu().findItem(R.id.nav_assigned_designs).setVisible(true);
