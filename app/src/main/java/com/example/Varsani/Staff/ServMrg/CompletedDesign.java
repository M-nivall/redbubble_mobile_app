...
import static com.example.Varsani.utils.Urls.URL_COMPLETED_DESIGNS;
import static com.example.Varsani.utils.Urls.URL_PENDING_ALLOCATION;
...
import com.example.Varsani.Staff.ServMrg.Adapters.AdapterCompletedDesigns;
...
public class CompletedDesign extends AppCompatActivity {
    private List<CompletedDesignModel> list;
    private AdapterCompletedDesigns adapterCompletedDesigns;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_completed_design);
    ...
    public void newOrders(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_COMPLETED_DESIGNS,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                adapterCompletedDesigns=new AdapterCompletedDesigns(getApplicationContext(),list);
                                recyclerView.setAdapter(adapterCompletedDesigns);
