...
public class AdapterOrdersItems extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterOrdersItems(Context context, List<OrderItemModal> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.lv_order_items, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.txv_price.setText(oi.getItemPrice());
