...
import static com.example.Varsani.utils.Urls.URL_AWAITING_ARRIVALS;
...
import com.example.Varsani.Staff.Store_mrg.Adapter.AdapterAwaitingArrival;
...
public class AwaitingStockArrival extends AppCompatActivity {
    private RecyclerView recyclerView;
    private ProgressBar progressBar;
    private List<RequestModel> list;
    private AdapterAwaitingArrival adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_awaiting_stock_arrival);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Awaiting Supplies Arrival");
    ...
    public void AwaitingRequests(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_AWAITING_ARRIVALS,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                adapter=new AdapterAwaitingArrival(getApplicationContext(),list);
