...
public class AdapterServiceCompleted extends RecyclerView.Adapter<AdapterServiceCompleted.ViewHolder> {

    private Context context;
    private List<CompletedModel> orderList;

    public AdapterServiceCompleted(Context context, List<CompletedModel> orderList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ViewCompletedItems.class);
