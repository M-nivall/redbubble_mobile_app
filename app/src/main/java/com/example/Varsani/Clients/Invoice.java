                        ...
                        try {
                            ...
                            if(status.equals("1")){
                                ...
                                for(int i=0; i <jsonArray.length();i++){
                                    ...
                                    String service_name=jsn.getString("service_name");
                                    String order_date=jsn.getString("order_date");
                                    String payment_id=jsn.getString("payment_id");
                                    ...
                                    InvoiceModal invoiceModal=new InvoiceModal(orderID,service_name,order_date,payment_id,
                                            service_fee,clientName,orderStatus);
