...
//    }
    ...
    public AdapterQuotation(Context context, List<OrderToShipModel> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterQuotation.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterQuotation.OriginalViewHolder) {
            final AdapterQuotation.OriginalViewHolder view = (AdapterQuotation.OriginalViewHolder) holder;
            ...
            view.txv_service.setText("Request date: "+o.getServName());
            ...
            view.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(ctx, QuotationItems.class);
