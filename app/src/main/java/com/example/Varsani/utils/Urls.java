...
public class Urls {
    ...
    public static String ipAddress = "https://6c727713f15c.ngrok-free.app/redbubble/";
...
//    SUPPLIERS
    ...
    public static final String URL_SUPPLY_ITEMS= ROOT_URL+"supplier/supply_items.php";
   // orders
