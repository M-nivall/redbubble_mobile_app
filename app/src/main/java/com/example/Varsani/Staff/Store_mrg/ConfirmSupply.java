...
import static com.example.Varsani.utils.Urls.URL_APPROVE_SUPPLY;
...
public class ConfirmSupply extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_supply);
        ...
        txv_amount = findViewById(R.id.txv_quotation);
    ...
    public void approve(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_APPROVE_SUPPLY,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("1")){
                                ...
                                Toast toast= Toast.makeText(ConfirmSupply.this, msg, Toast.LENGTH_SHORT);
                            ...
                            e.printStackTrace();
                            Toast toast= Toast.makeText(ConfirmSupply.this, e.toString(), Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.TOP,0,250);
                            toast.show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast toast= Toast.makeText(ConfirmSupply.this, error.toString(), Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.TOP,0,250);
                toast.show();
            }
        }){
